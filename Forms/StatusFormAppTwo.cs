...
namespace AppicationBot.Ver._2.Forms
{
    ...
    public class StatusFormAppTwo
    {
        ...
        public static IForm<StatusFormAppTwo> BuildForm()
        {
            ...
            OnCompletionAsyncDelegate<StatusFormAppTwo> processOrder = async (context, state) =>
            {
            ...
            var form = new FormBuilder<StatusFormAppTwo>();
            ...
            return form
                               .Field(new FieldReflector<StatusFormAppTwo>(nameof(appointmentId))
                               .SetType(null)
