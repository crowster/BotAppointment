            ...
            return form        //.Message("Select one of the dates availables for cancel the appointment, please")
                              ...
                              .SetDefine(async (state, field) =>
                              {
                                  ...
                                  try
                                  {
                                      ...
                                      //if (!ReservationCancel.context.UserData.TryGetValue("customerState", out customerState)) { customerState = new ACFCustomer(); }
                                  }
                                  catch (Exception ex)
                                  {
                                  ...
                                  if (customer == null)
                                  {
                                     // await state.Context.PostAsync($"The user is not valid");
